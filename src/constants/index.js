...
export const experiences = [
  ...
  // },
  {
    ...
    date: "2022",
    points: [
      "Assigned in four (4) divisions:",
      "Implemented simple RESTful method in an android application 'PC Inventory System with QR Scanner' in INFORMATION TECHNICAL SUPPORT DIVISION (ITSD)",
      "Monitoring of the PNP website. Researched about ransomware (researched about Goodwill Ransomware) in INFORMATION SYSTEMS SECURITY DIVISION (ISSD)",
      "Daily regular backup of database in DATA MANAGEMENT DIVISION (DMD)",
      "Created digital and illustrated artworks for PNP Social Media pages in  PLANS AND TRAINING DIVISION (PTD)",
    ],
  },
];
...
export const socialLinks = [
  ...
  },
  {
    name: "GitHub",
    iconUrl: github,
    link: "https://github.com/skatistics",
  },
  {
    name: "LinkedIn",
    iconUrl: linkedin,
    link: "https://www.linkedin.com/in/itsjoshuascott/",
  },
];
